...
namespace FriendStorage.UI.Behaviors
{
    public static class DataGridChangeBehavior
    {
        ...
        {
            Style baseStyle = dataGrid.FindResource(typeof(TextBox)) as Style;
            Style style = new Style(typeof(TextBox), baseStyle);
        ...
        {
            Style baseStyle = dataGrid.FindResource("TextBlockBaseStyle") as Style;
            Style style = new Style(typeof(TextBlock), baseStyle);
            AddSetters(style, bindingPath, dataGrid);
            return style;
        }
